					...
					<div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-start">
						...
						<div className="text-shade-on">
							...
							<p className="mt-6 max-w-2xl text-[20px] leading-[1.6] text-slate-100">
								Secured. Verified. Built for ROI — powered by AI to redefine construction finance.
							</p>

							<div className="mt-8 grid grid-cols-2 gap-6 text-[16px] font-bold text-white md:flex md:flex-wrap md:gap-8">
								<a className="hover:opacity-90" href="#">Back to Top</a>
								<a className="hover:opacity-90" href="#">For Investors</a>
								<a className="hover:opacity-90" href="#">Platform &amp; Solutions</a>
								<a className="hover:opacity-90" href="#">Company</a>
								<a className="hover:opacity-90" href="#">FAQ</a>
								<a className="hover:opacity-90" href="#">Terms</a>
								<a className="hover:opacity-90" href="#">Privacy</a>
								<a className="hover:opacity-90" href="#">Risk Disclaimer</a>
								<a className="hover:opacity-90" href="#">Contact Us</a>
							</div>
						</div>
